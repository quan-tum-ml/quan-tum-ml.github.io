...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.7360f3ff0775a8b0d6d69b532650fc9e2ce018292bc3976c525439cf1d108a51.js',function(){input.required=false;search();});}

...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.96dd6344eb5e5d6e60c4c1706ca84ac0ea7f253e3669ccaa916491396137b5d4.js',function(){input.required=false;search();});}
